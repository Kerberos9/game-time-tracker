      ...
      games: JSON.parse(localStorage.getItem('games')) || [
        {
          id: '36936',
          name: 'Nioh',
          image: 'https://howlongtobeat.com/games/36936_Nioh.jpg',
          played: 0,
          lastPlayed: 0
        },
        {
          id: '57351',
          name: 'FIFA 19',
          image: 'https://howlongtobeat.com/games/57351_Fifa_19.jpg',
          played: 0,
          lastPlayed: 0
        },
        {
          ...
          image: 'https://howlongtobeat.com/games/Detroit_Become_Human.jpg',
          played: 0,
          lastPlayed: 0
        }
      ],
  ...
  render() {
    return (
      <div className='app'>
        <Header />
        <CurrentGame
          updatePlayedGame={this.onGameEdit.bind(this)}
          onCancelTracking={this.onCancelTracking.bind(this)}
          game={this.state.currentGame}
          onGameEdit={this.onGameEdit.bind(this)}
        />
        ...
        <GameSorter
          ...
          onSortDirectionChange={this.onSortDirectionChange.bind(this)}
        ...
        {this.state.addingGame ? (
          <>
            <div className='overlay' onClick={this.toggleAddingGame.bind(this)} />
          </>
        ) : null}
      </div>
    );
